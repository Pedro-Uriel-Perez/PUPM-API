...
export type RolWhereInput = {
  ...
  ide?: Prisma.IntFilter<"Rol"> | number
...
export type RolScalarWhereWithAggregatesInput = {
  ...
  ide?: Prisma.IntWithAggregatesFilter<"Rol"> | number
...
export type RolUncheckedUpdateInput = {
  ide?: Prisma.IntFieldUpdateOperationsInput | number
  description?: Prisma.StringFieldUpdateOperationsInput | string
  status?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type RolOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"ide" | "description" | "status", ExtArgs["result"]["rol"]>
...
export interface RolDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `ide`
   * const rolWithIdeOnly = await prisma.rol.findMany({ select: { ide: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Rols and only return the `ide`
   * const rolWithIdeOnly = await prisma.rol.createManyAndReturn({
   *   select: { ide: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Rols and only return the `ide`
   * const rolWithIdeOnly = await prisma.rol.updateManyAndReturn({
   *   select: { ide: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface RolFieldRefs {
  readonly ide: Prisma.FieldRef<"Rol", 'Int'>
